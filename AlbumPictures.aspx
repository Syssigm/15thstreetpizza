<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="AlbumPictures.aspx.cs" Inherits="_15thstreetpizza.AlbumPictures" %>
	  ...
	  .albums-listing .album-col p {font-size: 14px; color: #000;}
        ...
        <div class="welcome clearfix" id="PICTURES">
          <h3>15thstreetPizza Picture Albums</h3>
            ...
            <div class="row">
                <asp:Repeater ID="albumrpt" OnItemDataBound="albumrpt_ItemDataBound" runat="server">
                <ItemTemplate>
              <div class="col-md-3 col-sm-6 album-col">
			  	<a href="#"><img src="<%#Eval("Catgimgurl") %>" border="0" class="album-img img-responsive img-thumbnail" /></a>
				<h4><a href="#"><%#Eval("CategoryName") %></a></h4>
				<p> <%#Eval("Catdescription") %></p>
				<asp:LinkButton ID="Lnkalbum" class="btn btn-warning" CommandArgument='<%#Eval("CategoryName") %>' OnClick="Lnkalbum_Click" runat="server">View Album</asp:LinkButton></div>
			...
			<%--<div class="col-md-3 col-sm-6 album-col">
             ...
             <%-- <div class="col-md-3 col-sm-6 album-col">
                ...
                <p class="text-right margin-0"><a id="backBTN" class="btn btn-danger" href="Default.aspx"><i class="glyphicon glyphicon-circle-arrow-left"></i> Back</a></p>
          </div>
