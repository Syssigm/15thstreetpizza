<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" Inherits="_15thstreetpizza.EventsSpecialoffers" %>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 map-col">
        <div class="welcome clearfix" id="PICTURES">
          <h3>Promotional & Special Events</h3>
            
          <%--<ul class="tabsone">
           <li class="active"  rel="tab1"><%# Eval("CategoryName") %></li>
        <li rel="tab2">Special Online Offers</li>
            <li rel="tab3">News & Events</li>
          </ul>--%>
          <div class="tab_container">
            <h3 class="d_active tab_drawer_heading" rel="tab1">Brew Fest</h3>
              ...
              <h4 class="blue"><%# Eval("SubCategoryName") %></h4>
           ...
           <%-- <h3 class="d_active tab_drawer_heading" rel="tab2">Employees</h3>
            ...
            <div id="tab3" class="tab_content">
              ...
              <ItemTemplate>
                  <h4 style="color:darkblue"><%# Eval("ImageUrl") %></h4>
