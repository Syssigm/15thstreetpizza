<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderOnline.aspx.cs" Inherits="PizzaV5.OrderOnline" %>
...
<body>
    <form id="form1" runat="server">
        <nav class="navbar navbar-fixed-top nav-15">
            ...
            <a href="OrderOnline.aspx" class="order-btn">
        ...
        <!--    <div class="text-center padding-bottom-20"><a href="OrderOnline.aspx">
            ...
            <nav class="nav" role="navigation">
                <ul class="nav__list">
                   ...
                   <li><a href="OrderOnline.aspx">
                <img src="images/orderonline-btn.png" class="img-responsive"></a></li>
                </ul>
    ...
    <!-- START BIGHOLLER ORDER ENGINE-->
        <%--   <h3> Order Online </h3>  -->
           <a class='chownow-order-online' target='_blank'></a>
        <%-- <div class="alert alert-danger bold text-center">REGISTER AND LOGON TO CHOWNOW FOR ONLINE ORDERING IN THE NEXT PAGE </div> -->
          <%--<iframe id="bhOrders" name="bhOrders" src="https://ordering.chownow.com/order/15147/locations" style="width:500px; height:400px; background-color:White;"  scrolling="auto"></iframe> --%>
    ...
    <script>window.__cnOrderNow = true;</script>
